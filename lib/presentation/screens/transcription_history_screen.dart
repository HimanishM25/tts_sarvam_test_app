        ...
        builder: (context) {
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                BlocBuilder<TranscriptHistoryScreenCubit, TranscriptHistoryScreenState>(
                  builder: (context, state) {
                    if (state is TranscriptHistoryScreenLoaded && state.history.isNotEmpty) {
                      return IconButton(
            ...
            body: BlocBuilder<TranscriptHistoryScreenCubit, TranscriptHistoryScreenState>(
              builder: (context, state) {
                if (state is TranscriptHistoryScreenLoading || state is TranscriptHistoryScreenInitial) {
                  return const Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(color: AppColors.textInactive, fontSize: 16),
                          ),
                        ],
                      ),
                    ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () => context
                                        .read<TranscriptHistoryScreenCubit>()
                                        .deleteTranscript(id),
